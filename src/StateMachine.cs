...
namespace Rest.StateMachines
{
    ...
    public interface IReadOnlyStateMachine<out TContext, in TEvent, in TArg1> : IReadOnlyStateMachine<TContext, TEvent>
        where TEvent : notnull
    {
    }
    
    public class StateMachine<TContext, TEvent> : IReadOnlyStateMachine<TContext, TEvent>, IDisposable where TEvent : notnull
    {
        ...
        public abstract class State : IDisposable
        {
            ...
            internal IReadOnlyStateMachine<TContext, TEvent> stateMachine = null!;
            ...
            protected IReadOnlyStateMachine<TContext, TEvent> StateMachine => stateMachine;
    ...
    public class StateMachine<TContext, TEvent, TArg1> : IReadOnlyStateMachine<TContext, TEvent, TArg1>, IDisposable where TEvent : notnull
    {
        const int DefaultCapacity = 10;
        ...
        {
            internal readonly Dictionary<TEvent, State> transitionTable;
            internal IReadOnlyStateMachine<TContext, TEvent, TArg1> stateMachine = null!;
            internal bool disposed;

            protected internal bool IsCallUpdate { get; protected set; } = true;
            protected internal virtual Predicate<TContext> CanTransition { get; protected set; } = _ => true;
            protected IReadOnlyStateMachine<TContext, TEvent, TArg1> StateMachine => stateMachine;
            protected TContext Context => StateMachine.Context;
            ...
            protected internal abstract void Enter();
            protected internal abstract void Update(TArg1 arg1);
            protected internal abstract void Exit();
            protected internal abstract bool GuardEvent(TEvent e);
            protected abstract void OnDispose();
        ...
        public void Update(in TArg1 arg1)
        {
            if (updateState != UpdateState.Idle)
            {
                throw new InvalidOperationException("StateMachine has not readying.");
